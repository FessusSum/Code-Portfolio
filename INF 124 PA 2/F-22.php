...
try {
	...
	$sql = "SELECT Designation, Name, Role, Manufacturer, Origin, Price, Crew, Length, Wingspan, Max_Speed, Paragraph_1, Paragraph_2, Armament, True_Price FROM `Planes` WHERE Designation = 'F-22A'";
...
<body>
	...
	<p style="font-size:200%;text-align:left;"> <img src="Pictures/F-22.jpg" alt="F-22" style="float:right;margin:0px 100px;width:615.2px;height:460.4px;">

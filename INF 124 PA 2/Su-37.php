...
try {
	...
	$sql = "SELECT Designation, Name, Role, Manufacturer, Origin, Price, Crew, Length, Wingspan, Max_Speed, Paragraph_1, Paragraph_2, Armament, True_Price FROM `Planes` WHERE Designation = 'Su-37'";
...
<body>
	...
	<p style="font-size:200%;text-align:left;"> <img src="Pictures/Su-37.jpg" alt="Su-37" style="float:right;margin:0px 100px;width:615.2px;height:460.4px;">
